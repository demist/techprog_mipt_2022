...
Правила игры практически не меняются по сравнению с тем, что было на промежуточной контрольной. 
Просьба ознакомиться [здесь](https://github.com/demist/techprog_mipt_2022#%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%B8%D0%B3%D1%80%D1%8B)

**Какие важные отличия?**
- В финальную контрольную войдет материал лекций *№1 - №12*
- Если вы напишете ее менее, чем на *30%* - ваши баллы за семестр "обнуляются" и вы идете на устный зачет (напомним, что финанальная контрольная - блокирующая)
- На выполнение контрольной у вас все так же **45 минут**

### Когда кто пишет

Всего есть два варианта времени, когда мы будем писать контрольную: *12.05 в 17:05* и *16.05 в 13:00*.

:fire: **Каждая группа самостоятельно решает, в какой день будет писать финальную контрольную**

Для этого староста каждой группы до *18:00 10.05* должен прислать pull-request с номером своей группы в один из списков ниже: 

#### Пишут контрольную *12.05 в 17:05*
- 121
- 

#### Пишут контрольную *16.05 в 13:00*
-
