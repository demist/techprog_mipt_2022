...
- Контрольная пройдет на базе Google Forms
	...
	- **Обратите внимание**: после ответа на все вопросы нужно нажать кнопку *ОТПРАВИТЬ*. Если вы эту кнопку не нажали - ответов мы не получили, а значит, вы получите за КР 0 баллов
		- Аппеляции после контрольной в стиле "я забыл нажать кнопку отправить" - приниматься не будут
...
Вопросы будут исключительно по лекционному материалу. В промежуточную контрольную войдут все темы лекция №1 - №6, кроме темы про *семейство гибких методологий* (ее мы на лекциях разобрать не успели)
...
- Не нужно нас пинговать вопросом *когда проверите?*
	...
	- Аргументация из серии *ну я хочу понимать как я написал КР, чтобы планировать дальнейшие действия по курсу* - контрпродуктивно для образовательного процесса
...
- **Нормировки по результатам контрольной не будет**
	- Даже если лучший балл будет в районе 50% от балла за КР - значит, такие баллы все и получат
	...
	- Соответственно, ситуации *преподавательский состав выдал гробы* исключается
